...
- Step 4 : In the report view, start to creating report.
- Step 5 : Visual filters (Slicers) were added for select "Month & Year".
- Step 6 : Three card visuals were added to the canvas, one representing total sales and total orders & other representing total quantity sold.
    - This card visual also displays additional information, such as month-over-month percentage differences, including indicators with positive or negative symbols to show growth or decline.

- Step 7 : A calendar view was created using a matrix visual, displaying daily sales with heat map-style coloring for better visual representation.
   - A tooltip has been implemented on this visual to provide additional information, such as the number of orders and quantity sold for each day.
